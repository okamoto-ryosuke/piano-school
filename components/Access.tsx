    ...
    <section id="access" className="mt-24 mb-12 scroll-mt-24">
      <Subtitle text="教室の場所について">
        <div className="text-center space-y-8 text-[#794C57]">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 text-sm bg-[#794C57]/5 p-6 rounded-2xl border border-[#794C57]/10">
            <p className="flex items-center gap-2 font-medium">
              <span className="text-base">🅿️</span> 駐車場あり（1台分）
            </p>
            <div className="hidden sm:block w-px h-4 bg-[#794C57]/20" />
            <p className="flex items-center gap-2 font-medium">
              <span className="text-base">🚲</span> 駐輪スペースあり
            </p>
          </div>
        </div>
      </Subtitle>
