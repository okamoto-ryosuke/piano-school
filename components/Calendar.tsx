...
export const Calendar = ({
  ...
  return (
    <div className="flex flex-col gap-3 md:gap-4">
      <div className="flex justify-end items-center gap-3 md:gap-4 px-3 md:px-4 pt-2">
        <span className="text-sm md:text-lg font-bold text-[#794C57] tracking-wider md:tracking-widest">
        ...
        <div className="flex gap-1">
          <button
            ...
            className={`p-1.5 md:p-2 rounded-full border border-[#794C57]/20 text-[#794C57] transition-all ${
              isPrevDisabled
      ...
      <div className="overflow-x-auto bg-white rounded-2xl shadow-sm border border-[#794C57]/10 font-[family-name:var(--font-hina)]">
        <div className="min-w-[600px] md:min-w-[800px] pb-8 pt-8 md:pb-12 md:pt-10">
          <div className="grid grid-cols-[70px_repeat(7,1fr)] md:grid-cols-[100px_repeat(7,1fr)] text-center text-[#794C57] mb-4 md:mb-6">
            <div className="border-r border-transparent"></div>
            {weekDays.map((date) => (
              <div
                key={date.toString()}
                className="px-1 md:px-2 border-r border-[#794C57]/10 last:border-r-0"
              >
                <div className="text-[13px] md:text-[18px] opacity-100 tracking-wider">
          ...
          <div className="relative border-[#794C57]/10">
            {HOURS.map((time, idx) => {
              ...
              return (
                <div
                  key={time}
                  className="grid grid-cols-[70px_repeat(7,1fr)] md:grid-cols-[100px_repeat(7,1fr)] relative"
                >
                  <div className="relative h-0 pointer-events-none">
                    <span className="absolute -top-[8px] md:-top-[10px] left-0 w-full text-center text-[11px] md:text-[15px] font-bold text-[#794C57]/80 pr-2 md:pr-4">
                      {time}
                    </span>
                  </div>
                    ...
                    weekDays.map((date) => {
                      ...
                      return (
                        <div
                          ...
                          className={`h-[46px] md:h-[60px] relative border-t border-[#794C57]/10 border-r border-[#794C57]/5 last:border-r-0
                        ...
                        >
                          ...
                          {isBooked && (
                            <div
                              className={`absolute inset-x-0.5 md:inset-x-1 bg-[#794C57]/90 text-white px-1 md:px-2 flex flex-col justify-center shadow-sm z-10
                            ...
                            >
                              {isStart && (
                                <span className="font-bold text-[10px] md:text-[13px] text-center tracking-tighter">
                                  予約済
                                </span>
                              )}
                            </div>
                          ...
                          {isSelected && (
                            <div
                              className={`absolute inset-x-0.5 md:inset-x-1 bg-[#794C57] text-white px-1 md:px-2 flex flex-col justify-center shadow-md z-20 animate-in fade-in zoom-in-95
                            ...
                            >
                              {isSelectionStart && (
                                <span className="font-bold text-[8px] md:text-[10px] text-center tracking-tighter">
                                  選択中
                                </span>
                              )}
                            </div>
