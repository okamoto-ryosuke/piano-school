...
export default function PriceFooter({ duration, price }: Props) {
  return (
    <div className="flex justify-between items-end border-b-2 border-[#794C57]/10 pb-2">
      <span className="text-xs md:text-sm font-bold text-[#794C57]">
        {duration} 〜
      </span>
      <span className="text-xl md:text-2xl font-bold text-[#794C57]">
        {price}
        <span className="text-[10px] md:text-xs ml-1 font-normal">円 〜</span>
      </span>
    </div>
  );
}
